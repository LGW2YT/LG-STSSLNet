...
class ST_Geo(nn.Module):
    def __init__(self, grid_in_channel, num_time_features, num_conv_layer, num_of_conv_filters, num_head, gru_hidden_size, emb_dim_final,
                 num_of_gru_layers, seq_len):
        super(ST_Geo, self).__init__()
        # Dynamic convolution layers
        self.grid_conv_star = Dynamic_conv2d(grid_in_channel, num_of_conv_filters//2, kernel_size=3, padding=1)

        if num_conv_layer > 2:
            self.grid_conv = clones(Dynamic_conv2d(num_of_conv_filters//2, num_of_conv_filters//2, kernel_size=3, padding=1), num_conv_layer - 2)

        self.grid_conv_fina = Dynamic_conv2d(num_of_conv_filters//2, num_of_conv_filters, kernel_size=3, padding=1)
...
class ST_HiddenCorr(nn.Module):
    def __init__(self, num_of_vertices, num_time_features, num_gcn_layer, num_of_graph_feature, num_of_graph_filters,
        ...
        super(ST_HiddenCorr, self).__init__()
...
class DG_STNET(nn.Module):
    def __init__(self,grid_in_channel, num_of_vertices, num_time_features, num_conv_layer, num_of_conv_filters, num_gcn_layer, num_head, gru_hidden_size, num_of_gru_layers,
                 ...
                 north_south_map, west_east_map):
        super(DG_STNET, self).__init__()
        self.north_south_map = north_south_map
        self.west_east_map = west_east_map
        self.seq_len = seq_len
        self.ST_Geo = ST_Geo(grid_in_channel, num_time_features, num_conv_layer, num_of_conv_filters, num_head, gru_hidden_size, emb_dim_final, num_of_gru_layers, seq_len)
        self.ST_Hid_Corr = ST_HiddenCorr(num_of_vertices, num_time_features, num_gcn_layer, num_of_graph_feature, num_of_graph_filters, gru_hidden_size, num_of_gru_layers, num_head, emb_dim_final,seq_len, cheb_k, K, emb_size,north_south_map, west_east_map)
