...
time_sim = torch.as_tensor(pkl.load(open('data/nyc/time_sim.pkl', 'rb')))
def contrast_loss(encode, risk_sim, target_time, grid_node_map, tempe = 0.1, region_contrast = True, tempora_contrast = True):
